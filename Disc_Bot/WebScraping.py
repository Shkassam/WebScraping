...
GEN = 783206568111767583 #ID For general chat in discord
...
async def scraping(scrape, bot):
    while True:
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} CanadaComputers.com{colors.END}  Asus ROG Strix   {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} MemoryExpress.com  {colors.END}  Asus ROG Strix   {colors.PINK}{e}{colors.END}')
            pass
        try:
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} Amazon.ca          {colors.END}  Asus ROG Strix   {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} Newegg.ca          {colors.END}  Asus ROG Strix   {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} BestBuy.ca         {colors.END}  Asus ROG Strix   {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} CanadaComputers.com{colors.END}  Asus TUF Gaming  {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} MemoryExpress.com  {colors.END}  Asus TUF Gaming  {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} Newegg.ca          {colors.END}  Asus TUF Gaming  {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} BestBuy.ca         {colors.END}  Asus TUF Gaming  {colors.PINK}{e}{colors.END}')
            pass
        try:
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} Amazon.ca          {colors.END}  Asus TUF Gaming  {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} Newegg.ca          {colors.END}  Ryzen 9 5900x    {colors.PINK}{e}{colors.END}')
            pass
        try: 
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} CanadaComputers.com{colors.END}  Ryzen 9 5900x    {colors.PINK}{e}{colors.END}')
            pass
        try:
            ...
            print(time.strftime(f"{colors.GREY}[%H:%M:%S]{colors.END}",time.localtime()), f'{colors.CYAN} Amazon.ca          {colors.END}  Ryzen 9 5900x    {colors.PINK}{e}{colors.END}')
            pass
